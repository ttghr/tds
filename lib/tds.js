  ...
  var pool = pools[poolName] = genericPool.Pool({
    ...
    create: function(callback) {
      ...
      var connectError = function() {
        ...
        /** callback with error */
        callback(connection.error && connection.error.sqlErrNo ? connection.error : null, connection);
      };
    ...
    max: c.poolSize || defaults.poolSize,
    min: c.minPoolSize || defaults.minPoolSize,
    idleTimeoutMillis: c.poolIdleTimeout || defaults.poolIdleTimeout,
    log: false
  });
